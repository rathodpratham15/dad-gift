...
import { Eye, Pencil, Star, Plus, CheckCircle, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {properties.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm text-center py-16 text-gray-500">
          ...
          <>
            ...
            <div className="md:hidden space-y-3">
              {properties.map((property) => (
                <div key={property.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-medium text-black text-sm line-clamp-1">{property.title}</p>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-gray-100">
                    <span className="text-sm font-medium text-black">{formatPrice(property.price)}</span>
                    <span
        ...
        {lastPage > 1 && (
          <div className="flex justify-center items-center gap-2 mt-6 flex-wrap">
            ...
            <Link
              href={`/admin/properties?page=${Math.min(lastPage, page + 1)}`}
