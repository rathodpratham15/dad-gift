    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        ...
        <div className="hidden lg:flex flex-col items-center text-center max-w-xs px-4 mb-4">
          <h2 className="text-2xl font-bold text-black/75 mb-2">Join Realest today</h2>
          <p className="text-black/50 text-sm leading-relaxed">
            Create a free account and start exploring premium properties tailored to your lifestyle.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" name="firstName" required placeholder="John" className={inputCls()} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Last Name</label>
                <input type="text" name="lastName" required placeholder="Doe" className={inputCls()} />
              </div>
            </div>
